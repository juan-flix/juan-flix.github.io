...
if (!defined('APP_NAME'))                       define('APP_NAME', 'JuanFlix');
if (!defined('APP_ORGANIZATION'))               define('APP_ORGANIZATION', 'JuanSytems');
if (!defined('APP_OWNER'))                      define('APP_OWNER', 'JuanDEV');
if (!defined('APP_DESCRIPTION'))                define('APP_DESCRIPTION', 'Aplication for watch movies.');
...
if (!defined('DB_PASSWORD'))                    define('DB_PASSWORD' ,'jflix#24#php');
